...
function Element:Colorpicker(Config, Window, PandaUI, OnApply)
    local Colorpicker = {
        __type = "Colorpicker",
        Title = Config.Title,
        Desc = Config.Desc,
    ...
    local ColorpickerFrame = ColorpickerModule.Create(nil, "Dialog", Window, PandaUI, Window.UIElements.Main.Main)
...
function Element:New(Config)
    ...
    Creator.AddSignal(Colorpicker.UIElements.Colorpicker.MouseButton1Click, function()
        if CanCallback then
            Element:Colorpicker(Colorpicker, Config.Window, Config.PandaUI, function(color, transparency)
